...
1. Go to the [Stylus extension page](https://add0n.com/stylus.html).
...
1. Go to the [Better YouTube Subtitles extension page](https://chromewebstore.google.com/detail/better-youtube-subtitles/ponocngkmjmakpleolejgelipolkmalm).
...
Run vorticon.reg to set SGA-Regular as system language,
and vorticon-restore.reg to return it to normal.
