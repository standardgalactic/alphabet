...
% luabidi required for RTL: sudo apt-get install texlive-lang-arabic
...
% AR environment: works with or without luabidi
% Uses explicit Amiri font + LuaTeX paragraph direction
\newenvironment{AR}{%
  \begingroup
  \AmiriFont
  \textdir TRT\pardir TRT\relax
}{%
  \endgroup
}
...
\newcommand{\arabicpagenum}{%
  {\AmiriFont\arabicnumerals{\arabic{arabicpagectr}}}%
}

\newcommand{\stepArabicPage}{\stepcounter{arabicpagectr}}

% Dactyl numeral commands for byobu pagination
\newcommand{\dactylwestern}{{\Dactyl\thepage}}
\newcommand{\dactylarabic}{{\AmiriFont\arabicnumerals{\arabic{arabicpagectr}}}}
...
\fancypagestyle{byobu-drift}{%
  ...
  \fancyfoot[LE]{\small\thepage}
  \fancyfoot[RO]{\small\thepage}
  \fancyfoot[RE]{\small\dactylarabic}
  \fancyfoot[LO]{\small\dactylarabic}
  \renewcommand{\headrulewidth}{0pt}
  \renewcommand{\footrulewidth}{0pt}
}
...
\fancypagestyle{byobu-return}{%
  \fancyhf{}
  \fancyfoot[LE]{\small\dactylwestern}
  \fancyfoot[RO]{\small\dactylwestern}
  \fancyfoot[RE]{\small\arabicpagenum}
  \fancyfoot[LO]{\small\arabicpagenum}
  \renewcommand{\headrulewidth}{0pt}
  \renewcommand{\footrulewidth}{0pt}
...
\stepArabicPage
\input{chapters/inter-de-loco-et-rebus}

\stepArabicPage
\input{chapters/01-de-pulsu-et-causa}

\stepArabicPage
\input{chapters/02-de-lege-et-negligentia}
...
\stepArabicPage
\input{chapters/03-de-voce-et-flumine}

\stepArabicPage
\input{chapters/04-de-scriptura-et-fragmento}

\stepArabicPage
\input{chapters/05-de-multiplicatione-narrationum}

\stepArabicPage
\input{chapters/06-de-defectu-et-calibratione}

\stepArabicPage
\input{chapters/07-de-observatione-et-dispositione}

\stepArabicPage
\input{chapters/08-de-necessitate-retroactiva}
...
\stepArabicPage
\input{chapters/09-de-compositione-regiminum}

\stepArabicPage
\input{chapters/10-de-iteratione-et-deriva}

\stepArabicPage
\input{chapters/11-de-cognitione-non-universali}
...
\rightpagesplit
\input{chapters/12-de-scripturis-et-formis}

\rightpagesplit
\input{chapters/13-de-interruptione-et-aula}

\stepArabicPage
\input{chapters/inter-de-apparatu}

\rightpagesplit
\input{chapters/14-de-confrontatione}
...
\leftpagecatch
\input{chapters/15-de-expositione-miraculi}

\leftpagecatch
\input{chapters/16-de-silentio-et-exilio}

\stepArabicPage
\input{chapters/inter-de-inventario}

\stepArabicPage
\input{chapters/inter-de-fuga}

\leftpagecatch
\input{chapters/17-de-porta-et-transitu}
...
\stepArabicPage
\input{chapters/18-de-itinere-et-resolutione}

\stepArabicPage
\input{chapters/inter-de-transitu-ii}

\stepArabicPage
\input{chapters/19-de-fez-et-continuatione}

\stepArabicPage
\input{chapters/inter-de-continuatione-arabic}

\stepArabicPage
\input{chapters/20-de-portu-et-translatione}

\stepArabicPage
\input{chapters/inter-de-transmision-spanish}

\stepArabicPage
\input{chapters/21-de-scriptorium-et-copia}

\stepArabicPage
\input{chapters/inter-de-arbore-et-volatu}

\stepArabicPage
\input{chapters/inter-dialogus-post-ignem}

\stepArabicPage
\input{chapters/22-de-parisiis-et-dissolutione}

\stepArabicPage
\input{chapters/inter-de-insula-animalium}

\stepArabicPage
\input{chapters/inter-de-continuitate-apparente}

\stepArabicPage
\input{chapters/inter-de-repetitione}

\stepArabicPage
\input{chapters/23-de-fine-quod-non-est-finis}
